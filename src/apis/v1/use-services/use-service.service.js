...
class UseServiceService {
  ...
  update({ bill_id, floor_id, room_id, service_id }, data) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        resolve(await this.getById(bill_id, floor_id, room_id, service_id));
      } catch (error) {
        reject(error);
      }
    });
  ...
  getById(bill_id, floor_id, room_id, service_id) {
    return new Promise(async (resolve, reject) => {
      try {
        const q = SqlString.format(
  ...
  deleteById(bill_id, floor_id, room_id, service_id) {
    return new Promise(async (resolve, reject) => {
      try {
        const q = SqlString.format(
